$(document).ready(function(){
    ...
    function cartTotal(){
        ...
        $(".cartList tr").each(function(){
            ...
            if(items>0){
                ...
                products[items] = ["'"+pName+"'","'"+pPrice+"'","'"+pQuantity+"'","'"+pTotal+"'","'"+pId+"'"];
                    ...
                    var productDetails = {
                                        ...
                                        // if ( localStorage.getItem('saveProduct')) {
                                        //     productData = JSON.parse(localStorage.getItem('saveProduct'))
                                        // } else {
                                        //     productData = []
                                        // }
            ...
            // var productDataStringify = JSON.stringify(productData)
            // localStorage.setItem('saveProduct', productDataStringify)
            // productDataStringify++;
        });
