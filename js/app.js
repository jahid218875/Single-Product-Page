$(document).ready(function(){
        ...
        if(localStorage.getItem("items") >0) {
            ...
            for(var i = 1;i<=items;i++){
                ...
                for(j;j<=max;j+=5){
                    ...
                    productsImage[id] = pImage

                    var productDetails = {
                                            product_id: productsId[id],
                                            product_name: productsName[id],
                                            product_price: productsPrice[id],
                                            product_quantity: productsQuantity[id],
                                            product_image: productsImage[id]
                                        }
                    ...
                    var row = "<tr><td>"+pName+"</td><td>"+pPrice+"</td><td>"+pQuantity+"</td><td>"+pTotal+"</td><td><button type='button' class='close itemRemove' aria-label='Close'><span aria-hidden='true'>&times;</span></button></td><td style='display:none'>"+pId+"</td></tr>";
                    $(".cartList").append(row);
                    id++;
                }
            }
    ...
    $(".itemBtn").click(function(){
        ...
        var productImage = $(".xzoom").attr("src");
        ...
        var a = "<tr><td>"+productName+"</td><td>"+productPrice+"</td><td>1</td><td>"+productPrice+"</td><td><button type='button' class='close itemRemove' aria-label='Close'><span aria-hidden='true'>&times;</span></button></td><td style='display:none'>"+productId+"</td><td style='display:none'>"+productImage+"</td></tr>";
        var flag = 0;
        var myCol= 0;
        var quantity = 0;
        var total = 0;
    ...
    function cartTotal(){
        ...
        $(".cartList tr").each(function(){
            ...
            var pImage = $(this).find("td").eq(6).text();

            total=total+pTotal;
            if(items>0){
                products[items] = ["'"+pName+"'","'"+pPrice+"'","'"+pQuantity+"'","'"+pTotal+"'","'"+pId+"'","'"+pImage+"'"];
            }
